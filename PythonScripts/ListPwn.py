...
NMAPcommand = f"sudo nmap -p- --min-rate 5000 -T4 -vvv -iL {IP} -oA Nmap/ports"
...
NMAP1command = "sudo nmap -A -p"+",".join(map(str, open_ports_list))+f" {rate} {Tspeed} -vvv -iL {IP} -oA Nmap/mapped"
...
NMAP2command = "sudo nmap --script=vuln -p"+",".join(map(str, open_ports_list))+f" {rate} {Tspeed} -vvv -iL {IP} -oA Nmap/vuln"
